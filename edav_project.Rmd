...
ggplot(flight_state) +
  ...
  labs(title = "Arrival and Departure Delay over States", x = "Average Delay in Mintutes", y = "", color = '') +
...
ggplot(flight_state) +
  ...
  labs(title = "Difference between Departure and Arrival Delay over States", x = "Average Difference in Mintutes", y = "", color = '')
...
diff_map$title = "Difference between Departure and Arrival Delay over States"
